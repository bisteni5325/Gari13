...
public abstract class Hilt_LeaderboardDetailsPageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeaderboardDetailsPageFragment() {
    super();
  }

  Hilt_LeaderboardDetailsPageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderboardDetailsPageFragment_GeneratedInjector) this.generatedComponent()).injectLeaderboardDetailsPageFragment(UnsafeCasts.<LeaderboardDetailsPageFragment>unsafeCast(this));
    }
  }
